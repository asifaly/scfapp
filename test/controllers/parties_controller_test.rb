...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { gst_no: @party.gst_no, name: @party.name, pan_no: @party.pan_no } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { gst_no: @party.gst_no, name: @party.name, pan_no: @party.pan_no } }
